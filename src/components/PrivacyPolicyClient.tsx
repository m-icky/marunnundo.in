            ...
            <div>
              ...
              <p className="text-slate-600 font-medium mt-2 max-w-2xl text-sm sm:text-base">
                {language === 'ml' ? (
                  ...
                  "Learn how Marunnundo.in collects, uses, protects, and respects your personal data."
                )}
              </p>
              ...
              {language === 'ml' ? (
                ...
                <>
                  ...
                  <section className="flex flex-col gap-4">
                    ...
                    <div className="text-sm sm:text-base leading-relaxed flex flex-col gap-4">
                      <p>
                        We may collect different types of information depending on how you interact with our platform:
                      </p>
                      ...
                      <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex flex-col gap-2">
                        ...
                        <ul className="list-disc pl-5 text-xs sm:text-sm flex flex-col gap-1.5 text-slate-600">
                          <li><strong>Location Data:</strong> With your permission, your device&apos;s precise GPS coordinates to help you find the nearest pharmacies.</li>
                          <li><strong>Search Information:</strong> The names of the medicines you search for, the districts, and the timestamps.</li>
                          <li><strong>Device Info:</strong> Your IP address, browser type, and timestamps of your website interactions.</li>
                        </ul>
                      </div>
                      ...
                      <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex flex-col gap-2">
                        ...
                        <ul className="list-disc pl-5 text-xs sm:text-sm flex flex-col gap-1.5 text-slate-600">
                          <li><strong>Account Details:</strong> Name, mobile number, email address, and encrypted password.</li>
                          <li><strong>Pharmacy Details:</strong> Pharmacy name, complete physical address, contact numbers, WhatsApp number, and map coordinates (latitude and longitude).</li>
                          <li><strong>Licensing Details:</strong> Official Drug License number issued by the Drugs Control Department for verification status.</li>
                          <li><strong>Inventory Details:</strong> Names, brands, pricing, and stock status of medicines available in your pharmacy.</li>
                        </ul>
                      </div>
                    </div>
                  </section>
                  ...
                  <section className="flex flex-col gap-3">
                    ...
                    <div className="text-sm sm:text-base leading-relaxed flex flex-col gap-3">
                      <p>We use the collected information for the following key business purposes:</p>
                      <ul className="list-disc pl-5 flex flex-col gap-2 text-slate-600">
                        <li>To display nearby pharmacies and their live medicine availability dynamically on the map.</li>
                        <li>To maintain, monitor, and optimize the overall performance and security of our platform.</li>
                        <li>To verify pharmacy licensing documents and prevent unauthorized or illegal pharmacy listings.</li>
                        <li>To send relevant notifications, customer messages, or operational updates to pharmacy owners.</li>
                        <li>To improve user experience and support services based on user feedback.</li>
                      </ul>
                    </div>
                  </section>
                  ...
                  <section className="flex flex-col gap-3">
                    ...
                    <div className="text-sm sm:text-base leading-relaxed flex flex-col gap-3">
                      <p>
                        We do not sell, rent, or trade your personal information to third-party marketers. However, we may share information in these specific circumstances:
                      </p>
                      <ul className="list-disc pl-5 flex flex-col gap-2 text-slate-600">
                        <li><strong>Mapping Services:</strong> Anonymous location details may be shared with our map provider integrations (OpenStreetMap/Mapbox) to calculate routing.</li>
                        <li><strong>Legal and Compliance:</strong> We are obligated to disclose details if requested under legal summons by the Drugs Control Department or other authorized law enforcement agencies.</li>
                      </ul>
                    </div>
                  </section>
                  ...
                  <section className="flex flex-col gap-3">
                    ...
                    <div className="text-sm sm:text-base leading-relaxed flex flex-col gap-3">
                      <p>
                        We employ industry-standard security measures, including strong encryption algorithms for credentials, to safeguard database transmissions. While we strive to protect your data, no method of transmission over the internet or cloud storage is 100% secure, and we cannot guarantee absolute security.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="flex flex-col gap-3">
                    ...
                    <div className="text-sm sm:text-base leading-relaxed flex flex-col gap-3">
                      <p>
                        We utilize secure session cookies and browser LocalStorage to enhance user experience, remember your preferences (such as language selection), and keep you logged in. You can manage or disable cookie settings in your browser at any time.
                      </p>
                    </div>
                  </section>
                  ...
                  <section className="flex flex-col gap-3">
                    ...
                    <div className="text-sm sm:text-base leading-relaxed flex flex-col gap-3">
                      <p>All users have the following choices and rights regarding their data:</p>
                      <ul className="list-disc pl-5 flex flex-col gap-2 text-slate-600">
                        <li>The right to view, inspect, and update or correct the personal data we hold about you.</li>
                        <li>The right to disable browser or device location permissions at any time.</li>
                        <li>The right for pharmacy owners to delete their accounts and permanently wipe their inventory listings.</li>
                      </ul>
                    </div>
                  </section>
                  ...
                  <section className="flex flex-col gap-3">
                    ...
                    <div className="text-sm sm:text-base leading-relaxed flex flex-col gap-3">
                      <p>
                        We reserve the right to revise or update this Privacy Policy at our discretion. Any revisions will be reflected on this page with an updated timestamp.
                      </p>
                    </div>
                  </section>
                </>
